...
public class RegisterController extends BaseController {
    ...
    public @ResponseBody
    Message submit(String captchaId, String captcha, String username,String number,String topNumber,String password1, String parent, String email,Integer zone, HttpServletRequest request, HttpServletResponse response, HttpSession session) {
