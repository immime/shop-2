...
public class RegisterController extends BaseController {
	...
	public @ResponseBody
	boolean checkParent(String parent) {
	...
	public @ResponseBody
	boolean checkTop(String topNumber) {
	...
	public @ResponseBody
	Map<String, Object> changeNumber() {
	...
	public @ResponseBody
	Message submit(String captchaId, String captcha, String username, String number, String parent,String zone, String topNumber,HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		...
		if(pMember.getMyPeople()==0){//没有推荐别人或者是推荐的人没有一个激活了。那就是放在推荐人的左边，节点人的左边
			//找到推荐人左边的会员，判断当前选择的节点人是否是在该会员的左边
			top = memberService.findChild(pMember, Zone.left);
		}else{//推荐的人有激活的。那么就是放在选择的区域
