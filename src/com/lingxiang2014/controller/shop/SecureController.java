...
@Controller("shopSecureController")
...
public class SecureController extends BaseController {
	...
	public String index(String redirectUrl, HttpServletRequest request, ModelMap model) {
		...
		return "/shop/secure/index";
	}

	@RequestMapping(value = "/submit", method = RequestMethod.POST)
	public @ResponseBody
	Message submit(String captchaId, String captcha, String number, HttpServletRequest request, HttpServletResponse response, HttpSession session) {
